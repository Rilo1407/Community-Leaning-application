...
TYPE
  ...
  Private
    DBVidSharer: TConnectMode; // Connection to DB
    tblAdvert: TADOtable; // Tables that you work with
    tblVideos: TADOtable;
    tblVidSharer: TADOtable;
    dsrAdvert: TDataSource; // Data source for first table
    dsrVideos: TDataSource; // Data souirce for second table
    dsrVidSharer: TDataSource;
  public
